...
public class ShortestPathDirected {
    ...
    public static void main(String[] args) {
        ...
        graph.addWeightedEdge(0, 2, 3,true);
        graph.addWeightedEdge(1, 2, 2,true);
        graph.addWeightedEdge(1, 3, 6,true);
        graph.addWeightedEdge(2, 3, 7,true);
        graph.addWeightedEdge(2, 4, 4,true);
        graph.addWeightedEdge(2, 5, 2,true);
        graph.addWeightedEdge(3, 4, -1,true);
        graph.addWeightedEdge(4, 5, -2,true);
